package top.whr.requestservice.crawler;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://ff14.bluefissure.com/";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"main-menu\"]/li/a/span");//*[@id="newbie_guide"]/div[2]/div[1]/ul/li[2]/a

                    System.out.println(titleNodes.length);
                    // 6. 输出结果
                    System.out.println("----- wiki首页导航 -----");
