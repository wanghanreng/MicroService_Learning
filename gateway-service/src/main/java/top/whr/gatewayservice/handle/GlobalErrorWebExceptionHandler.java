package top.whr.gatewayservice.handle;
...
@Component // 设置优先级，确保该异常处理器优先于其他异常处理器生成
@Order(-2)
public class GlobalErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
     ...
     * @param applicationContext Spring 应用上下文，用于获取bean信息。
     * @param serverCodecConfigurer 用于配置消息编码器和解码器，以支持JSON等格式的请求。
     */
